...
MEDIA_ROOT = 'media/'  # Путь где будут хранитьсся прикрепленные файлы
MEDIA_URL = '/media/'  # Ссылка для обращения к файлам
...
EMAIL_HOST_USER = "newsportal2@yandex.ru"
EMAIL_HOST_PASSWORD = "NewsPortal"
